...
mixin _$AttendanceState {
  ...
  AttendanceStateStatus get status;
  String? get message;
...
extension AttendanceStatePatterns on AttendanceState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<Attendance> data, AttendanceStateStatus status,
            String? message)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _AttendanceState() when $default != null:
        return $default(_that.data, _that.status, _that.message);
      case _:
        return orElse();
    }
  }
...
class _AttendanceState implements AttendanceState {
  const _AttendanceState(
      {final List<Attendance> data = const [],
